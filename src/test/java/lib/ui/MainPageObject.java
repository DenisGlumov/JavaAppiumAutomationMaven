...
public class MainPageObject {
    ...
    public WebElement assertElementHasText(String locator, String text, String error_message) {
    ...
    public void scrollWebWebPageTillElementNotVisible(String locator, String error_message, int max_swipe) {
        int already_swipe = 0;
    ...
    public String waitForElementAndGetAttribute(String locator, String attribute, String error_message, long timeeoutInSeconds) {
        WebElement element = waitForElementPresent(locator, error_message, timeeoutInSeconds);
    ...
    private By getLocatorByString(String locator_with_type) {
        ...
        if (by_type.equals("xpath")) {
            ...
            //MobileBy.AccessibilityId(locator);
    ...
    public List<WebElement> getElementSearch(String locator) {
        By by = this.getLocatorByString(locator);
        List<WebElement> elementSearch = driver.findElements(by);
